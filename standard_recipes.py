...
# Version: 1.2
# Description:
# This script inserts standard/default recipes into the database
# if the database is empty. It creates categories, recipes,
# ingredients, and preparation steps for initial application data.
